...
def load_configs():
    ...
    parser.add_argument("--cwl2_max_iter", type=int, default=10, help="")
    parser.add_argument("--cwl2_binary_search_steps", type=int, default=10, help="")
    parser.add_argument("--cwl2_initial_const", type=float, default=0.01, help="")
...
def main():
    ...
    attack = CarliniL2Method(classifier=art_classifier, max_iter=cfgs['cwl2_max_iter'], 
                            binary_search_steps=cfgs['cwl2_binary_search_steps'], initial_const=cfgs['cwl2_initial_const'], batch_size=1)
