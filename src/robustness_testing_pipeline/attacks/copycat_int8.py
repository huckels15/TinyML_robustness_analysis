...
def main():
    ...
    if cfgs['dataset_id'] == 'cifar10':
        ...
        if cfgs['theived_template'] == 'vgg': 
            thieved_model = theived_templates_cifar.create_vgg16()
            arch = 'vgg'
        elif cfgs['theived_template'] == 'lenet': 
            thieved_model = theived_templates_cifar.create_lenet()
            arch = 'lenet'
        elif cfgs['theived_template'] == 'alexnet': 
            thieved_model = theived_templates_cifar.create_alexnet()
            arch = 'alexnet'
        elif cfgs['theived_template'] == 'resnet': 
            thieved_model = theived_templates_cifar.create_resnet()
            arch = 'resnet'
        else: 
            thieved_model = theived_templates_cifar.create_basic()
            arch = 'basic'
