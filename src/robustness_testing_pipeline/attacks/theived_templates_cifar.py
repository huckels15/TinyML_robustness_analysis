...
def create_vgg16():
    ...
    # Layer 1 & 2
    vgg16.add(Conv2D(64, (3, 3), padding='same', input_shape=(32, 32, 3), kernel_regularizer=l2(0.)))
    ...
    # Layers 8, 9, & 10 (reduced number of filters)
    vgg16.add(Conv2D(128, (3, 3), padding='same'))
    vgg16.add(Activation('relu'))
    vgg16.add(Conv2D(128, (3, 3), padding='same'))
    vgg16.add(Activation('relu'))
    ...
    # Layers 11, 12, & 13 (Flatten and Dense)
    vgg16.add(Flatten())
    vgg16.add(Dense(512))  # Reduced from 4096 to 512
    vgg16.add(Activation('relu'))
    vgg16.add(Dropout(0.5))
    vgg16.add(Dense(512))  # Reduced from 4096 to 512
    vgg16.add(Activation('relu'))
    vgg16.add(Dropout(0.5))
    vgg16.add(Dense(10))  # Output layer for 10 classes
