...
from art.attacks.evasion.geometric_decision_based_attack_int8 import GeoDA_Int8
...
def main():
    ...
    attack = GeoDA_Int8(estimator=art_classifier, bin_search_tol=cfgs['geoda_bin_search_tol'], sub_dim=cfgs['geoda_sub_dim'],
