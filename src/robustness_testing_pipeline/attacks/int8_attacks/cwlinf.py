...
def load_configs():
    ...
    parser.add_argument("--cwlinf_max_iter", type=int, default=10, help="")
    parser.add_argument("--cwlinf_learning_rate", type=float, default=0.01, help="")
...
def main():
    ...
    attack = CarliniLInfMethod(classifier=art_classifier, learning_rate=cfgs['cwlinf_learning_rate'],
                               max_iter=cfgs['cwlinf_max_iter'], batch_size=1)
