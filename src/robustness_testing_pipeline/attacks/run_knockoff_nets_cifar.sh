...
QNN_INT8='models/trainedResnet_testable_logits_quant.tflite'
...
# echo "=============================================================="
# echo "======================KnockoffNets -- VGG =============================="
# echo "VGG Arch Results:" >> knockoff_cifar_results.txt
# python3 knockoff_nets_int8.py --dataset_id "$DATASET_ID" --num_classes "$NUM_CLASSES" --target_int8 "$QNN_INT8" --theived_template "$VGG" >> knockoff_cifar_results.txt
# echo "" >> knockoff_cifar_results.txt
