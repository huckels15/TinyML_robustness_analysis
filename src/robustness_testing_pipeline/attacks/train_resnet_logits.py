...
if __name__ == "__main__":
    ...
    plt.savefig("some_train_images.png")

    new_model = keras_model_logits.resnet_v1_eembc()
    new_model.summary()
    ...
    new_model.compile(
        optimizer=optimizer, loss=loss_func, metrics=['accuracy'], loss_weights=None,
