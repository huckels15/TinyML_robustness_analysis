...
from art.attacks.evasion.zoo_int8 import ZooAttack_Int8
...
def main():
    ...
    attack = ZooAttack_Int8(classifier=art_classifier, max_iter=cfgs['zoo_max_iter'], binary_search_steps=cfgs['zoo_binary_search_steps'],
